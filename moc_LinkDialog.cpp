...
QT_INIT_METAOBJECT const QMetaObject LinkDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_LinkDialog.data,
    qt_meta_data_LinkDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
