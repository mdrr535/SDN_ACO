...
void NetworkMap::visualizePath(QList<int> path, QColor color)
{
    NetworkVisualizer visualizer(matrices.getGraphMatrix(), nodes, switches);
    visualizer.visualizePath(path, color);
}
